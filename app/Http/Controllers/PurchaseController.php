...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        $banks = DB::table('transfer_balance_bank')->where('deleted_at',null)->get();
        ...
        try {
            ...
            foreach ($purchases as $purchase) {
                ...
                if (!empty($purchase['exp_date'])) {
                    $new_purchase_line['exp_date'] = $this->productUtil->uf_date(str_replace('/', '-', $purchase['exp_date']));
                }
    ...
    public function edit($id)
    {
        ...
        $taxes = TaxRate::where('business_id', $business_id)
                            ->get();
        $orderStatuses = $this->productUtil->orderStatuses();
        $product = DB::table('products')->where('id',$id)->where('business_id',$business_id)->get();
        $business_locations = BusinessLocation::forDropdown($business_id);
