...
class HomeController extends Controller
{
     ...
     */
       ...
       public function uploadLogo(Request $request){
        $request->validate([
            'image' => 'required|image|min:1000|max:3000',
        ]);

  $query = FacadesDB::table("logo")->where("id","1");


//   $prev_img =    "/img" . "/" . $query->first()->name;
   ...
   return back();
    ...
    public function index()
    {
        ...
        $sells_chart_2 = Charts::create('bar', 'highcharts')
         ...
         $balance = CashRegister::orderBy('id', 'desc')->first()->cash_register_transactions_sum();



                            return view('home.index', compact('date_filters', 'sells_chart_1', 'sells_chart_2',"balance"));
    }
