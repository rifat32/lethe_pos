...
class StockTransferController extends Controller
{
            ...
            /*$stock_transfers = Transaction::join(
                ...
                'l1.id'
                    ...
                    ->select(
                        ...
                        //'purchase_lines.id as quantity',
                        DB::raw('SUM(purchase_lines.id) As revenue'),
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($sell_lines)) {
                $this->transactionUtil->createOrUpdateSellLines($sell_transfer, $sell_lines, $input_data['location_id'],$user_id);
            }
