    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //Add Approve Amount
            $inputs['paid_on'] = \Carbon::now()->toDateString();
            $inputs['transaction_id'] = $transaction->id;
            $inputs['amount'] = $this->transactionUtil->num_uf( $transaction_data['final_total']);
            $inputs['created_by'] = auth()->user()->id;
            $inputs['payment_for'] = 0;
            $inputs['transaction_no'] = '';
            $inputs['account_id'] = 0;
            $inputs['method'] = 'cash';
            ...
            $this->transactionUtil->updatePaymentStatus($transaction->id, $inputs['amount']);
            //Add Approve Amount
