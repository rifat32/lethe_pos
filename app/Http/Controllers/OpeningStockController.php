...
class OpeningStockController extends Controller
{
    ...
    public function add2($product_id)
    {
        ...
        if (!empty($product)) {
            ...
            if (request()->ajax()) {
                return view('opening_stock.ajax_add2')
                    ->with(compact(
                        'product',
                        'locations',
                        'purchases',
            ...
            return view('opening_stock.add2')
                    ->with(compact(
                        'product',
                        'locations',
                        'purchases',
                            ...
                            foreach ($rows as $key => $v) {
                                ...
                                if ($qty > 0) {
                                    ...
                                    if (isset($v['purchase_line_id'])) {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id, $product->id, $k, $qty_formated, $old_qty);
                                    } else {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id, $product->id, $k, $qty_formated);
                                    }
