        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($brands)
                ->addColumn(
                    ...
                    @endcan
                    @can("brand.delete")
                        <button data-info="This Brand will be Deleted" data-href="{{action(\'BrandController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_brand_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                    @endcan'
                )
                ->removeColumn('id')
                ->rawColumns([2])
