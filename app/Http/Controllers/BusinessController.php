    ...
    */
    ...
    public function __construct(BusinessUtil $businessUtil, RestaurantUtil $restaurantUtil, ModuleUtil $moduleUtil)
    {
        ...
        $this->avlble_modules = ['tables' => [ 'name' => __('restaurant.tables'),
            ...
            'internal_banking' => ['name' => __('Internal Banking')],
            'transfer_balance' => ['name' => __('Transfer Balance')],
            'receive_balance' => ['name' => __('Receive Balance')],
            'internal_kitchen' => ['name' => __('Internal Kitchen')],
            'hr_management' => ['name' => __('HRM')],
            'warranty' => ['name' => __('Warranty')]
        ];
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('business_logo') && $request->file('business_logo')->isValid()) {
                $path = $request->business_logo->store('public/');
                $business_details['logo'] = str_replace('public/', '', $path);
            }
