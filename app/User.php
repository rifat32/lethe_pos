...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'surname', 'first_name', 'last_name', 'username', 'email', 'password', 'business_id', 'is_cmmsn_agnt', 'contact_no', 'address', 'cmmsn_percent', 'language', 'selected_contacts', 'salary'
    ];
     ...
     * @return array users
     */
    public static function forDropdown($business_id, $prepend_none = true, $include_commission_agents = false)
    {
