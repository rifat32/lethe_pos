...
@endphp
                        ...
                        <td>
                            {{ $order->netTotal + $order->shipping + $order->area_shipping - $order->discount }}
                        </td>
                        <td>
                            @php
                        ...
                        <td class="text-left">
                            ...
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                            onclick="invoice('{{route('order.invoice.print', $order->id)}}')"
                             title="Print Invoice">
...
const invoice = (link) => {
  ...
  var mywindow = window.open('', 'new div', 'height=4000,width=4000');
    mywindow.document.body.innerHTML = data.html
