...
<section class="content-header">
    ...
    @if($sell)
    <h1>
        <a class="btn btn-danger text-capitalize" >already sold to pos</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-muted h5" id="total">
                                {{ $order->grand_total + $order->shipping + $order->area_shipping -   $order->discount }}
...
//         if(delivery_status == "delivered") {
//     location.replace(`https://bdpetcare.com/pos/orders/create-sell/ecommerce-sell/${order_id}`);
// }
        toastr.success("Data Updated");
