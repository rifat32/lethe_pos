...
<section class="content no-print">
	...
	<br>
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 info-box-width">
			<div class="info-box">
				<!--  <span class="info-box-icon bg-aqua"><i class="ion ion-ios-cart-outline"></i></span> -->

				<div class="info-box-content">
					<span class="info-box-text">Cash</span>
					<span class="info-box-number ">৳{{number_format($balance,0)}}</span>
				</div>
				<!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
		...
		<div class="col-md-3 col-sm-6 col-xs-12 info-box-width">
			<div class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">Pusrhase</span>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="box box-warning">
				<div class="box-header">
					...
					<h3 class="box-title">{{ __('lang_v1.sales_payment_dues') }} @show_tooltip(__('lang_v1.tooltip_sales_payment_dues'))</h3>
				</div>
				<div class="box-body">
		...
		<div class="col-sm-6">
			<div class="box box-warning">
				<div class="box-header">
					<i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
					<h3 class="box-title">{{ __('lang_v1.purchase_payment_dues') }} @show_tooltip(__('tooltip.payment_dues'))</h3>
				</div>
				<div class="box-body">
