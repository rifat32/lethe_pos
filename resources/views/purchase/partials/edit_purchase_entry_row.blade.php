    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr>
            ...
            <td>
                ...
                ['class' => 'form-control input-sm purchase_quantity input_number mousetrap', 'required', 'data-rule-abs_digit' => $check_decimal, 'data-msg-abs_digit' => __('lang_v1.decimal_value_not_allowed')]); !!} {{ $purchase_line->product->unit->short_name }}
            </td>
            <td>
            ...
            <td hidden>
        <input type="text" name="mrp_price" value="{{$purchase_line->mrp_price}}" class="form-control input-sm input_number default_sell_price">
        </td>
        <td hidden>
        <input type="text" name="reseller_price" value="{{$purchase_line->reseller_price}}" class="form-control input-sm input_number default_sell_price">
        </td>
            @if(session('business.enable_lot_number'))
                <td>
