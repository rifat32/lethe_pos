				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="form-group">
						<div class="input-group">
							...
							{!! Form::text('search_product',  $_GET['p_name'], ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' => __('lang_v1.search_product_placeholder'), 'autofocus']); !!}
							@else
...
@section('javascript')
	...
	$(document).ready( function() {
		...
		$('#discount_amount_').on('blur', function(){
			calDiscount();
	...
	function calDiscount(){
		var final=0;
		var type = $('select#selectDynamic').find('option:selected').val();
		var dis=$('#discount_amount_').val();
		...
		$('#grand_total_hidden').val(final);
		$('#grand_total').text(final);
		$('#payment_due').text(final);
	}
</script>
