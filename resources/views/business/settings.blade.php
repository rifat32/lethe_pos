        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <!-- <a href="#" class="list-group-item text-center">Internal Banking</a>
                    <a href="#" class="list-group-item text-center">Transfer Balance</a>
                    <a href="#" class="list-group-item text-center">Receive Balance</a> -->
                </div>
            </div>
