...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select('time_zone', $timezone_list, 'Asia/Dhaka', ['class' => 'form-control select2_register','placeholder' => __('business.time_zone'), 'required']); !!}
        </div>
    </div>
</div>
</fieldset>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('first_name', null, ['class' => 'form-control','required','placeholder' => __('business.first_name'), 'required']); !!}
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('username', null, ['class' => 'form-control','required','placeholder' => __('business.username'), 'required']); !!}
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::password('password', ['class' => 'form-control','required','placeholder' => __('business.password'), 'required']); !!}
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::password('confirm_password', ['class' => 'form-control','required','placeholder' => __('business.confirm_password'), 'required']); !!}
        </div>
    </div>
</div>
<div class="clearfix"></div>
