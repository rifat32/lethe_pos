<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <a href="{{route('contact.last.payment',$contact_details->contact_id)}}" id="print-payment" style="display:none;"></a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="well">
            ...
            <strong>@lang('contact.total_purchase_due'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase - $contact_details->total_paid -$contact_details->total_stock_return}}</span><br>
