			...
			<table class="table bg-gray">
				<tr class="bg-green">
					...
					@can('access_default_selling_price')
				        ...
				        <th>@lang('Excellent Price') (@lang('product.exc_of_tax'))</th>
				        <th>@lang('Excellent price') (@lang('product.inc_of_tax'))</th>
				...
				<tr>
					...
					@can('access_default_selling_price')
						...
						<td>
							<span class="display_currency" data-currency_symbol="true">{{ $product->reseller_price }}</span>
						</td>
						<td>
							<span class="display_currency" data-currency_symbol="true">{{ $product->mrp_price }}</span>
						</td>
					@endcan
					@if(!empty($allowed_group_prices))
