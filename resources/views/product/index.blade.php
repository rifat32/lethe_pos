            	...
            	<table class="table table-bordered table-striped ajax_view table-text-center" id="product_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            <td colspan="9">
                                {{-- <strong>
                                @lang('sale.total'):</strong> --}}
                                
                            </td>
                            <td id="f-default_purchase_price"></td>
                            <td id="f-sell_price_inc_tax"></td>
                            <td id="f-discount"></td>
                            <td id="f-tax"></td>
                        </tr>
                    </tfoot>
            ...
            var product_table = $('#product_table').DataTable({
                ...
                columns: [
                    ...
                    @endcan
                      ...
                      { data: 'sell_price_inc_tax', name: 'variations.sell_price_inc_tax'},
                      { data: 'discount', name: 'discount'},
                        // { data: 'shipping_price', name: 'products.shipping_price'},
...
$('#f-default_purchase_price').text(sum_table_col($('#product_table'), 'default-purchase-price'));
$('#f-sell_price_inc_tax').text(sum_table_col($('#product_table'), 'sell-price-inc-tax'));
$('#f-discount').text(sum_table_col($('#product_table'), 'discount'));
$('#f-tax').text(sum_table_col($('#product_table'), 'tax'));
