...
{!! Form::open(['url' => action('ServiceController@store'), 'method' => 'post',
'id' => 'product_add_form','class' => 'product_form', 'files' => true ]) !!}

 {!! Form::hidden('unit_id', 0, ['class' => 'form-control ', 'required',
 'placeholder' => "name"]); !!}

    {!! Form::text('category_id', 30, ['class' => 'form-control ','style' => 'display:none; ', 'required',
    'placeholder' => "name"]); !!}
    ...
    <div class="box-body">
      <div class="row">
           ...
           {{-- <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('name', "Shipping Price". ':*') !!}
                  {!! Form::text('shipping_price', null, ['class' => 'form-control', 'required', 'placeholder' =>"Shipping Price"]); !!}
              </div>
          </div> --}}
        ...
        {{-- <div class="col-sm-4">
          ...
          {!! Form::hidden('enable_stock', 1 , ['class' => 'form-control', 'required',
          'placeholder' => __('product.alert_quantity'), 'min' => '0']); !!}

        {!! Form::hidden('alert_quantity', !empty($duplicate_product->alert_quantity) ? $duplicate_product->alert_quantity : 999 , ['class' => 'form-control', 'required',
        'placeholder' => __('product.alert_quantity'), 'min' => '0']); !!}
        ...
        <div class="col-sm-4" style="display:none">
            <div class="form-group">
                {!! Form::label('name', "Discount". ':*') !!}
                  ...
                  {!! Form::hidden('doctor_commission', 0, ['class' => 'form-control', 'required', 'placeholder' =>"Commission"]); !!}
        ...
        <div class="form-group">
            ...
            {!! Form::number('discount', !empty($duplicate_product->discount) ? $duplicate_product->discount : null , ['class' => 'form-control', 'required',
...
<td >
  <br/>
  {!! Form::text('cost', 0, ['class' => 'form-control input-sm input_number', 'id' => 'cost', 'required']); !!}
</td>
...
{{--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ product form --}}
        ...
        <input type="hidden" id="default_profit_percent"
		  ...
		  <div class="col-sm-4 form-group" style="margin-left: 10%; display:none">
           <label style="background: #5cb85c;color: #fff;padding: 4px;">Wholesale Price:*</label>
           <input type="text" name="reseller_price" value="0" class="form-control" placeholder="Wholesale Price">
         </div>
         <div class="col-sm-4 form-group" style="display:none">
           <label style="background: #5cb85c;color: #fff;padding: 4px;">Regular Price:*</label>
           <input type="text" name="mrp_price" value="0" class="form-control" placeholder="Regular Price">
         </div>
