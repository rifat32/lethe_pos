...
<section class="content">
  <div class="box">
    <div class="box-body">
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbbank.view', in_array('tbbank.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbbank.create', in_array('tbbank.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbbank.update', in_array('tbbank.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbbank.delete', in_array('tbbank.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
        </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Transfer Balance Personal</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbpersonal.view', in_array('tbpersonal.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbpersonal.create', in_array('tbpersonal.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbpersonal.update', in_array('tbpersonal.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'tbpersonal.delete', in_array('tbpersonal.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbbank.view', in_array('rbbank.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbbank.create', in_array('rbbank.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbbank.update', in_array('rbbank.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbbank.delete', in_array('rbbank.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Receive Balance Personal</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbpersonal.view', in_array('rbpersonal.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbpersonal.create', in_array('rbpersonal.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbpersonal.update', in_array('rbpersonal.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'rbpersonal.delete', in_array('rbpersonal.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibuser.view', in_array('ibuser.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibuser.create', in_array('ibuser.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibuser.update', in_array('ibuser.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibuser.delete', in_array('ibuser.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Internal Bank Transaction</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibtransaction.view', in_array('ibtransaction.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibtransaction.create', in_array('ibtransaction.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibtransaction.update', in_array('ibtransaction.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibtransaction.delete', in_array('ibtransaction.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibcategory.view', in_array('ibcategory.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibcategory.create', in_array('ibcategory.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibcategory.update', in_array('ibcategory.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ibcategory.delete', in_array('ibcategory.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Internal Kitchen raw Items</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikitem.view', in_array('ikitem.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikitem.create', in_array('ikitem.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikitem.update', in_array('ikitem.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikitem.delete', in_array('ikitem.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Internal Kitchen Dish Category</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdcategory.view', in_array('ikdcategory.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdcategory.create', in_array('ikdcategory.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdcategory.update', in_array('ikdcategory.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdcategory.delete', in_array('ikdcategory.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        <div class="col-md-1">
          <h4>Internal Kitchen Dish List</h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdlist.view', in_array('ikdlist.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdlist.create', in_array('ikdlist.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdlist.update', in_array('ikdlist.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ikdlist.delete', in_array('ikdlist.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.show.delete' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'supplier_report.view', in_array('supplier_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.supplier_report.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
