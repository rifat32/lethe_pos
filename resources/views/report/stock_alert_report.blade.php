        ...
        <div class="col-md-12">
            <div class="box box-primary" id="accordion">
              ...
              <div id="collapseFilter" class="panel-collapse active collapse in" aria-expanded="true">
                <div class="box-body">
                  {!! Form::open(['url' => action('ReportController@getStockAlertReport'), 'method' => 'get', 'id' => 'stock_alert_report_filter_form' ]) !!}
                    <div class="col-md-3">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped" id="stock_alert_report_table">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('report.initial_stock')</th>
