...
<h1 id="sound" style="display:none;">  {{ url()->current() }}</h1>
		...
		@if(!$pos_layout)
			...
			<div class="alert alert-success alert-dismissible no-print" style="margin-left: 10px;   margin-right: 10px;display:none">
               	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>SIS POS V2.11.2 Released. Most advance Stock Management / POS application for Growing Businesses. One software for ALL type of business.-->
<br>
