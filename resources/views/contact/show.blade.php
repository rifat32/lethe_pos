            ...
            <div class="row">
                ...
                <div  class="col-sm-3">
                    ...
                    @if( $contact->type == 'supplier' || $contact->type == 'both')
                        ...
                        <p class="text-muted">
                        <span class="display_currency" data-currency_symbol="true">
                        {{ $contact->total_purchase - $contact->purchase_paid -$contact->total_stock_return }}</span>
                        </p>
                ...
                <div class="col-sm-3">
                    <div style="margin-bottom: .5rem;">
                        <a class="btn btn-primary btn-lg" href="{{route('sell.payments',$contact->id)}}" style="width:20rem;text-align:start;"> <i class="fa fa-money" aria-hidden="true"></i> View Payments</a>
                    </div>
                    <div style="margin-bottom: .5rem;">
                        @if(($contact->total_purchase - $contact->purchase_paid) > 0 || ($contact->total_sell - $contact->sell_paid) > 0)
                        <a href="{{action('TransactionPaymentController@getPayContactDue', [$contact->id])}}?type={{$contact->t_type}}" class="pay_purchase_due btn btn-danger btn-lg " style="width:20rem;text-align:start;"><i class="fa fa-money" aria-hidden="true"></i> @lang("contact.pay_due_amount")</a>
                    @endif
                    </div>
                    <div style="margin-bottom: .5rem;">
                        <a href="{{action('TransactionPaymentController@getAddAdvance', [$contact->id])}}" class="pay_purchase_due btn btn-success btn-lg " style="width:20rem; text-align:start;"><i class="fa fa-money" aria-hidden="true"></i> Add Advance</a>
                    </div>
                ...
                @if( $contact->type == 'supplier' ||  $contact->type == 'customer' || $contact->type == 'both')
