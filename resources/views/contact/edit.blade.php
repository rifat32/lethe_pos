  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              {!! Form::label('selling_price_groups_id', __('lang_v1.selling_price_groups') . ':') !!}
              <div class="input-group">
                  <span class="input-group-addon">
                      <i class="fa fa-users"></i>
                  </span>
                  {!! Form::select('selling_price_groups_id', $selling_price_groups, $contact->selling_price_groups_id, ['class' => 'form-control']); !!}
              </div>
          </div>
        </div>
