     ...
     <div class="form-group">
      ...
      {{-- <div class="form-group">
        {!! Form::label('name', "Shipping Price". ':*') !!}
          {!! Form::text('shipping_price', $category->shipping_price, ['class' => 'form-control', 'required', 'placeholder' =>"Shipping Price"]); !!}
      </div> --}}
      <div class="form-group">
        {!! Form::label('name', "Order". ':*') !!}
          {!! Form::text('order', $category->order, ['class' => 'form-control', 'required', 'placeholder' =>"order"]); !!}
      </div>
      <div class="form-group">
