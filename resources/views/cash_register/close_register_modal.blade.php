        ...
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_due_paid }}</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{  $total_internal_transfer->total }}</span>
              </td>
            </tr>
            <tr>
              <td>
              Total Internal Received:
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{  $total_internal_receive->total }}</span>
              </td>
            </tr>
            <tr>
              <td>
                Total Received From Bank:
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $total_bank_receive->total }}</span>
              </td>
            </tr>
            <tr>
              <td>
                Total Received In Person:
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $total_personal_receive->total }}</span>
              </td>
            </tr>
            <tr>
              <td>
                Total Transfred To Bank:
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $total_bank_transfer->total }}</span>
              </td>
            </tr>
            <tr>
              <td>
                Total Transfred In Person:
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $total_personal_transfer->total }}</span>
              </td>
            </tr>
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{$total_internal_receive->total -  $total_internal_transfer->total + $register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund + $total_personal_receive->total + $total_bank_receive->total - $total_personal_transfer->total - $total_bank_transfer->total -$sell_return}}</span></b>
              </td>
            </tr>
          </table>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('closing_amount', __( 'cash_register.total_cash' ) . ':*') !!}
              {!! Form::text('closing_amount', @num_format( $register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund + $total_personal_receive->total + $total_bank_receive->total - $total_personal_transfer->total - $total_bank_transfer->total -$sell_return), ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'cash_register.total_cash' ) ]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
