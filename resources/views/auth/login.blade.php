...
<div class="container-fluid login_layout">
    <div class="row ">
        {{-- <div class="col-md-6 col-lg-6 right_block"></div> --}}
        <div class="col-md-6 col-md-offset-3 login_left_area">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                {{-- <button id="getCode" type="button" class="btn btn-primary">get code</button> --}}
    ...
    document.getElementById("getCode").addEventListener("click", () => {
        $.post('{{ route('get.code') }}', {
            ...
            username: document.getElementById("username").value,
             ...
             window.alert("contact with admin")
        });
    });
