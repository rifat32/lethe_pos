$(document).ready( function(){
    ...
    //Supplier report
    report_supplier_tbl = $('#report_supplier_tbl').DataTable({
        processing: true,
        serverSide: true,
        "bDestroy": true,
        ajax: '/reports/report-supplier',
        columnDefs: [ 
            {"targets": [5], "orderable": false, "searchable": false},
        ...
        "fnDrawCallback": function (oSettings) {
            __currency_convert_recursively($('#report_supplier_tbl'));
        }
    });
    //Stock report table
    stock_report_table = $('#stock_report_table').DataTable({
                            ...
                            columns: [
                                ...
                                {data: 'sku', name: 'sku'},
                                {data: 'name', name: 'name'},
                                {data: 'default_purchase_price', name: 'V.default_purchase_price'},
                                ...
                                {data: 'mrp_price', name: 'mrp_price', searchable: false},
                                {data: 'mrp_sell_price', name: 'mrp_sell_price', searchable: false}
   ...
   $('#f-default_purchase_price').text(sum_table_col($('#stock_report_table'), 'default-purchase-price'));



                                
$('#f-sell_price_inc_tax').text((sum_table_col($('#stock_report_table'), 'sell-price-inc-tax')).toFixed(2));
                                ...
                                $('#footer_total_transfered').html(__sum_stock($('#stock_report_table'), 'initial_stock'));
                                ...
                                $('#footer_total_amount').text(sum_table_col($('#stock_report_table'), 'mrp-price'));
                                
                                $('#footer_total_sell_amount').text(sum_table_col($('#stock_report_table'), 'mrp-sell-price'));
                                
                                __currency_convert_recursively($('#stock_report_table'));
                            }
                        });
    stock_alert_report_table = $('#stock_alert_report_table').DataTable({
                            processing: true,
                            serverSide: true,
                            "ajax": {
                                "url": "/reports/stock-alert-report",
                                "data": function ( d ) {
                                    d.location_id = $('#location_id').val();
                                    d.category_id = $('#category_id').val();
                                    d.sub_category_id = $('#sub_category_id').val();
                            ...
                            "fnDrawCallback": function (oSettings) {
                                $('#footer_total_stock').html(__sum_stock($('#stock_alert_report_table'), 'current_stock'));
                                $('#footer_total_sold').html(__sum_stock($('#stock_alert_report_table'), 'total_sold'));
                                $('#footer_total_transfered').html(__sum_stock($('#stock_alert_report_table'), 'initial_stock'));
                                $('#footer_total_transfered').html(__sum_stock($('#stock_alert_report_table'), 'total_transfered'));
                                $('#footer_total_adjusted').html(__sum_stock($('#stock_alert_report_table'), 'total_adjusted'));
                                __currency_convert_recursively($('#stock_alert_report_table'));
                            }
                        });
    ...
    $('#stock_report_filter_form #location_id, #stock_report_filter_form #category_id, #stock_report_filter_form #sub_category_id, #stock_report_filter_form #brand, #stock_report_filter_form #unit, #stock_report_filter_form #supplier_id,#stock_report_filter_form #view_stock_filter').change( function(){
        stock_report_table.ajax.reload();
        stock_expiry_report_table.ajax.reload();
    });

    $('#stock_alert_report_filter_form #location_id, #stock_alert_report_filter_form #category_id, #stock_alert_report_filter_form #sub_category_id, #stock_alert_report_filter_form #brand, #stock_alert_report_filter_form #unit,#stock_alert_report_filter_form #view_stock_filter').change( function(){
        stock_alert_report_table.ajax.reload();
        stock_expiry_report_table.ajax.reload();
    });
    ...
    $('#product_purchase_report_form #variation_id, #product_purchase_report_form #location_id, #product_purchase_report_form #supplier_id, #product_purchase_report_form #category_id, #product_purchase_report_form #sub_category_id, #product_purchase_report_form #brand_id, #product_purchase_report_form #product_pr_date_filter').change( function(){
        product_purchase_report.ajax.reload();
    });
    ...
    $('#product_sell_report_form #variation_id, #product_sell_report_form #location_id, #product_sell_report_form #customer_id, #product_sell_report_form #category_id, #product_sell_report_form #sub_category_id, #product_sell_report_form #brand_id, #product_sell_report_form #product_sr_date_filter').change( function(){
        product_sell_report.ajax.reload();
    });
...
function updateProfitLoss(){
    ...
    var loader = __fa_awesome();
    $(' .total_internal_received, .total_internal_balance, .total_invoice_due, .total_cost, .opening_stock, .total_transfer_shipping_charges, .closing_stock, .total_sell, .total_purchase, .total_expense, .net_profit, .total_adjustment, .total_recovered, .total_sell_discount, .total_purchase_discount, .total_purchase_return, .total_sell_return').html(loader);
    ...
    $.ajax({
        ...
        data: data,
        success: function(data){
            $('.total_cost').html(__currency_trans_from_en( data.total_cost, true ));
            $('.total_invoice_due').html(__currency_trans_from_en( data.invoice_due, true ));
            ...
            $('.total_sell_return').html(__currency_trans_from_en( data.total_sell_return, true ));
            $('.total_internal_expense').html(__currency_trans_from_en( data.total_internal_expense, true ));
            $('.total_internal_received').html(__currency_trans_from_en( data.total_internal_received, true ));
            $('.total_internal_balance').html(__currency_trans_from_en( data.total_internal_balance, true ));
