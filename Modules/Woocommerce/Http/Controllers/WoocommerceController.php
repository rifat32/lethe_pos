...
use App\Business, App\BusinessLocation, App\TaxRate,
    App\SellingPriceGroup, App\Category, App\Product,
    App\System;
...
class WoocommerceController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!(auth()->user()->can('superadmin') || $this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package'))) {
    ...
    public function apiSettings()
    {
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package') && auth()->user()->can('woocommerce.access_woocommerce_api_settings') ) )){
            abort(403, 'Unauthorized action.');
        }
        ...
        return view('woocommerce::woocommerce.api_settings')
                ->with(compact('default_settings', 'locations', 'price_groups', 'module_version'));
    }
    ...
    public function syncCategories()
    {
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package') && auth()->user()->can('woocommerce.syc_categories')) )){
            abort(403, 'Unauthorized action.');
        }
    ...
    public function syncProducts()
    {
        ...
        $business_id = request()->session()->get('business.id');
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package') && auth()->user()->can('woocommerce.sync_products') ) )){
            abort(403, 'Unauthorized action.');
        }
    ...
    public function syncOrders(){
        ...
        $business_id = request()->session()->get('business.id');
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package') && auth()->user()->can('woocommerce.sync_orders')) )){
            abort(403, 'Unauthorized action.');
        }
    ...
    public function mapTaxRates(Request $request)
    {
        ...
        $business_id = request()->session()->get('business.id');
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'woocommerce_module', 'superadmin_package') && auth()->user()->can('woocommerce.map_tax_rates') ) )){
            abort(403, 'Unauthorized action.');
        }
